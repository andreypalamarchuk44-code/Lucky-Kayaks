...
const FAQS = [
  {
    ...
    a: 'Ні, для маршруту «Заливи Ладижин» та вечірнього сплаву досвід не потрібен — інструктор проведе короткий інструктаж перед виходом на воду. Для порогів II–III категорії просимо хоча б один попередній сплав.',
  },
  {
